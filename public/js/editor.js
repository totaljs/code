	...
	CodeMirror.defineMode('totaljs:inner', function() {
		return {
			token: function(stream) {
				...
				if (stream.match(/COMPONENTS|COMPONENT|PLUGIN|EXTENSION|RECONFIGURE|ERROR|EMIT|AJAX|TAPI|WAPI|DAPI|UPLOAD|ENVIRONMENT|ASETTER|SETTER|AEXEC|EXEC|EXE|NAV|REDIRECT|ATTRD|SET|GET|PUSH|INC|HIDDEN|IMPORT|FIND|APPEARANCE|WATCH|CONFIG|CLINIT|CLRELOAD|ROUTE|CORS|UPDATE|UPD|FLAGS/, true))
					return 'b';
...
SNIPPETS.push({ type: 'html', search: '~ID~', text: '<b>~ID~</b>', code: '~ID~', ch: 5 });
SNIPPETS.push({ type: 'html', search: '~CDN~', text: '<b>~CDN~</b>', code: '~CDN~', ch: 6 });
...
SNIPPETS.push({ type: 'html', search: 'data ui import', text: '<b>ui-import</b>', code: '<ui-import config="url:"></ui-import>', ch: 24 });
...
SNIPPETS.push({ type: 'js', search: 'NEWTRANSFORM', text: '<b>NEWTRANSFORM</b>', code: 'NEWTRANSFORM(\'\', async function($, value) {\n\t{0}value.name = value.name.toUpperCase();\n\t{0}$.next();\n{0}});', ch: 15 });
...
SNIPPETS.push({ type: 'js', search: 'NEWSUBSCRIBE', text: '<b>NEWSUBSCRIBE</b>', code: 'NEWSUBSCRIBE(\'\', async function(data) {\n\t{0}\n{0}});', ch: 15 });
SNIPPETS.push({ type: 'js', search: 'NEWMIDDLEWARE', text: '<b>NEWMIDDLEWARE</b>', code: 'NEWMIDDLEWARE(\'\', async function($) {\n\t{0}$.next();\n{0}});', ch: 16 });
SNIPPETS.push({ type: 'js', search: 'NEWEXTENSION', text: '<b>NEWEXTENSION</b>', code: 'NEWEXTENSION(\'https://\', function(err, module) {\n\t{0}\n{0}});', ch: 23 });
SNIPPETS.push({ type: 'js', search: 'NEWTHREAD', text: '<b>NEWTHREAD</b>', code: 'NEWTHREAD(\'{1}\');', ch: 12 });
SNIPPETS.push({ type: 'js', search: 'NEWTHREADPOOL', text: '<b>NEWTHREADPOOL</b>', code: 'NEWTHREADPOOL(\'{1}\', 3);', ch: 16 });
...
SNIPPETS.push({ type: 'js', search: 'exports.model', text: '<b>exports.model</b>', code: 'exports.model;', ch: 15 });
SNIPPETS.push({ type: 'js', search: 'exports.form', text: '<b>exports.form</b>', code: 'exports.form;', ch: 14 });
SNIPPETS.push({ type: 'js', search: 'exports.data', text: '<b>exports.data</b>', code: 'exports.data;', ch: 14 });
SNIPPETS.push({ type: 'js', search: 'exports.modified', text: '<b>exports.modified</b>', code: 'exports.modified;', ch: 18 });
SNIPPETS.push({ type: 'js', search: 'exports.set', text: '<b>exports.set()</b>', code: 'exports.set(\'\', value);', ch: 14 });
SNIPPETS.push({ type: 'js', search: 'exports.upd', text: '<b>exports.upd()</b>', code: 'exports.upd(\'\');', ch: 14 });
SNIPPETS.push({ type: 'js', search: 'exports.nul', text: '<b>exports.nul()</b>', code: 'exports.nul(\'\');', ch: 14 });
SNIPPETS.push({ type: 'js', search: 'exports.inc', text: '<b>exports.inc()</b>', code: 'exports.inc(\'\');', ch: 14 });
SNIPPETS.push({ type: 'js', search: 'exports.push', text: '<b>exports.push()</b>', code: 'exports.push(\'\');', ch: 15 });
SNIPPETS.push({ type: 'js', search: 'exports.extend', text: '<b>exports.extend()</b>', code: 'exports.extend(\'\');', ch: 17 });
SNIPPETS.push({ type: 'js', search: 'exports.reset', text: '<b>exports.reset()</b>', code: 'exports.reset(\'\');', ch: 16 });
SNIPPETS.push({ type: 'js', search: 'exports.tapi', text: '<b>exports.tapi()</b>', code: 'exports.tapi(\' @showloading ERROR\', model, function(response) {\n\t{0}\n{0}});', ch: 15 });
SNIPPETS.push({ type: 'js', search: 'exports.ajax', text: '<b>exports.ajax()</b>', code: 'exports.ajax(\' @showloading ERROR\', model, function(response) {\n\t{0}\n{0}});', ch: 15 });
SNIPPETS.push({ type: 'js', search: 'exports.upload', text: '<b>exports.upload()</b>', code: 'exports.upload(\' @showloading ERROR\', files, function(response) {\n\t{0}\n{0}});', ch: 17 });
SNIPPETS.push({ type: 'js', search: 'exports.watch', text: '<b>exports.watch()</b>', code: 'exports.watch(\'\', function(value) {\n\t{0}\n{0}});', ch: 16 });
...
SNIPPETS.push({ type: 'js', search: 'COMPONENTATOR', text: '<b>COMPONENTATOR</b>', code: 'COMPONENTATOR(\'\', \'exec,errorhandler,locale,notify,importer,page\');', ch: 16 });
...
SNIPPETS.push({ search: 'params', text: 'params', code: 'params', ch: 7 });
