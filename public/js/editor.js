	...
	CodeMirror.defineMode('totaljs:inner', function() {
		return {
			token: function(stream) {
				...
				if (stream.match(/COMPONENT|PLUGIN|EXTENSION|RECONFIGURE|EMIT|AJAX|TAPI|WAPI|DAPI|UPLOAD|ENVIRONMENT|ASETTER|SETTER|AEXEC|EXEC|NAV|REDIRECT|ATTRD|SET|GET|PUSH|INC|HIDDEN|IMPORT|FIND|APPEARANCE|WATCH|CONFIG|CLINIT|CLRELOAD|ROUTE/, true))
					return 'b';
