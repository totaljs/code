...
SNIPPETS.push({ type: 'js', search: 'dbms DBMS list', text: '<b>DBMS().list(...).autoquery()</b>', code: 'DBMS().list(\'\').autoquery($, \'id:uid,name:string,dtcreated:date,dtupdated:date\', \'dtcreated_desc\', 100).where(\'isremoved=FALSE\').callback($.callback);', ch: 14, line: 0, priority: 1 });
