	...
	CodeMirror.defineMode('totaljs:inner', function() {
		return {
			token: function(stream) {
				...
				if (stream.match(/data-released=|~PATH~|~CDN~|~ID~|--[\w=\s]+--/, true))
					return 'variable-R';
...
SNIPPETS.push({ type: 'js', search: 'schema.setSave setsave', text: '<b>schema.setSave</b>', code: 'schema.setSave(async function($, model) {\n\t{0}\n{0}});', ch: 21, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setPatch setpatch', text: '<b>schema.setPatch</b>', code: 'schema.setPatch(async function($, model) {\n\t{0}var id = $.id;\n\t{0}model.dtupdated = NOW;\n{0}});', ch: 1, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setInsert setinsert', text: '<b>schema.setInsert</b>', code: 'schema.setInsert(async function($, model) {\n\t{0}var id = UID();\n\t{0}model.id = id;\n\t{0}model.dtcreated = NOW;\n{0}});', ch: 1, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setUpdate setupdate', text: '<b>schema.setUpdate</b>', code: 'schema.setUpdate(async function($, model) {\n\t{0}var id = $.id;\n\t{0}model.dtupdated = NOW;\n{0}});', ch: 1, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setRemove setremove', text: '<b>schema.setRemove</b>', code: 'schema.setRemove(async function($) {\n\t{0}var id = $.id;\n{0}});', ch: 1, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setQuery setquery', text: '<b>schema.setQuery</b>', code: 'schema.setQuery(async function($) {\n\t{0}\n{0}});', ch: 2, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setList setquery', text: '<b>schema.setList</b>', code: 'schema.setList(async function($) {\n\t{0}\n{0}});', ch: 2, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setRead setread', text: '<b>schema.setRead</b>', code: 'schema.setRead(async function($) {\n\t{0}var id = $.id;\n{0}});', ch: 1, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setGet setget', text: '<b>schema.setGet</b>', code: 'schema.setGet(async function($) {\n\t{0}var id = $.id;\n{0}});', ch: 1, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setSaveExtension', text: '<b>schema.setSaveExtension</b>', code: 'schema.setSaveExtension(async function($, data) {\n\t{0}\n{0}});', ch: 21, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setPatchExtension', text: '<b>schema.setPatchExtension</b>', code: 'schema.setPatchExtension(async function($, data) {\n\t{0}\n{0}});', ch: 22, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setInsertExtension', text: '<b>schema.setInsertExtension</b>', code: 'schema.setInsertExtension(async function($, data) {\n\t{0}\n{0}});', ch: 2, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setUpdateExtension', text: '<b>schema.setUpdateExtension</b>', code: 'schema.setUpdateExtension(async function($, data) {\n\t{0}\n{0}});', ch: 2, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setRemoveExtension', text: '<b>schema.setRemoveExtension</b>', code: 'schema.setRemoveExtension(async function($, data) {\n\t{0}\n{0}});', ch: 2, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setQueryExtension', text: '<b>schema.setQueryExtension</b>', code: 'schema.setQueryExtension(async function($, data) {\n\t{0}\n{0}});', ch: 2, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setListExtension', text: '<b>schema.setListExtension</b>', code: 'schema.setListExtension(async function($, data) {\n\t{0}\n{0}});', ch: 2, line: 1, priority: 1 });
SNIPPETS.push({ type: 'js', search: 'schema.setReadExtension', text: '<b>schema.setReadExtension</b>', code: 'schema.setReadExtension(async function($, data) {\n\t{0}\n{0}});', ch: 2, line: 1, priority: 1 });
